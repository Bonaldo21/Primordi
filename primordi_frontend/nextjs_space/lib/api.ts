...
export const pedidosApi = {
  ...
  create: (data: { enderecoEntregaId?: number | null; retiradaNaLoja?: boolean; lojaRetirada?: string; itens: { produtoId: number; quantidade: number }[]; cupomCodigo?: string; valorFrete?: number; observacoes?: string }) =>
